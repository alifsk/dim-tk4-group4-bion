    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
            <div class="container-fluid">
                <a class="navbar-brand" href="/">DIM Group 4</a>
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link @if(Route::currentRouteName() === 'access.index') active @endif" href="{{ route('access.index') }}">Manajemen Hak Akses</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link @if(Route::currentRouteName() === 'user.index') active @endif" href="{{ route('user.index') }}">Manajemen Pengguna</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link @if(Route::currentRouteName() === 'product.index') active @endif" href="{{ route('product.index') }}">Manajemen Barang</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <footer class="mt-3 mb-5 text-center">
            <p class="text-center">&copy; 2024 Group 4 Data and Information Management</p>
        </footer>
